...
?>
	...
	<tbody>
	 <?php
	   ...
	   if ($pg=='pveri'){
	   	$qry = mysqli_query("SELECT * FROM pendaftar $qPrefix AND psSt_Verifikasi='1'");
	   }elseif($pg=='plulus'){
	   	$qry = mysqli_query("SELECT * FROM pendaftar $qPrefix AND psSt_Seleksi='1'");
	   }elseif($pg=='pnveri'){
	   	$qry = mysqli_query("SELECT * FROM pendaftar $qPrefix AND psSt_Verifikasi='0'");
	   }elseif($pg=='pnlulus'){
	   	$qry = mysqli_query("SELECT * FROM pendaftar $qPrefix AND psSt_Seleksi='0'");
	   }elseif($pg=='pendaftar'){
	   	$qry = mysqli_query("SELECT * FROM pendaftar $qPrefix");
	   }
